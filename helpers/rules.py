...
regex_rules = [
    ...
    (r'.*:|[a-zA-Z]{3,}', tt.LABEL),
    # 16-bit registers
    (r'af|AF', tt.REGISTER_AF),
    (r'bc|BC', tt.REGISTER_BC),
    (r'de|DE', tt.REGISTER_DE),
    (r'hl|HL', tt.REGISTER_HL),
    (r'sp|SP', tt.REGISTER_SP),
    (r'pc|PC', tt.REGISTER_PC),
    # 8-bit Registers
    (r'a|A', tt.REGISTER_A),
    (r'b|B', tt.REGISTER_B),
    (r'c|C', tt.REGISTER_C),
    ...
    (r'l|L', tt.REGISTER_L),
    # Conditions
    (r'nz|NZ', tt.CONDITION_NZ),
    (r'z|Z', tt.CONDITION_Z),
    (r'nc|NC', tt.CONDITION_NC),
